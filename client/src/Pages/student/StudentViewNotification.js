        ...
        <div align="center">
            ...
            <Column p={0} gap={0} className={styles.card}>
                ...
                <div align="left">
                    ...
                    <PersonItem name={'Virtusa'}
                                src={'http://bizenglish.adaderana.lk/wp-content/uploads/VirtusaLogo-Dec-11JPG6-1.jpg'}/>
                    <Divider variant={'middle'} className={styles.divider}/>
                    <PersonItem name={'Pearson'} src={'https://www.britishcouncil.lk/sites/default/files/pearson.png'}/>
                    <Divider variant={'middle'} className={styles.divider}/>
                    <PersonItem name={'PickMe'}
                                src={'https://images.g2crowd.com/uploads/product/image/social_landscape/social_landscape_b036e85a65d2a2071d4eb61cfecb93bf/pick-me.png'}/>
                    <Divider variant={'middle'} className={styles.divider}/>
                    <PersonItem name={'LSEG'}
                                src={'https://assets.lsegissuerservices.com/original-20872d3e-3947-4500-bda2-a9bfc722aaea.png'}/>
                </div>
            </Column>
